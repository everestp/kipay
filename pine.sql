-- Enable UUID extension if needed (using custom string IDs in this arch, but good to have)
...
-- ==========================================
-- 2. ADMIN USERS TABLE (New: Supports Admin Routes)
-- ==========================================
...
-- ==========================================
-- 9. BLACKLISTED ADDRESSES TABLE (New: Settlement Security Pre-Check)
-- ==========================================
...
-- ==========================================
-- 12. WEBHOOK LOGS TABLE (Enhanced with Payload & Retry tracking)
-- ==========================================
