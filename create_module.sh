...
import (
	"go-backend/modules/$MODULE_NAME/service"
	"go-backend/modules/$MODULE_NAME/validation"
	"go-backend/pkg/constants"
...
import (
	"go-backend/modules/$MODULE_NAME/repository"
	"gorm.io/gorm"
)
...
import (
	"go-backend/modules/$MODULE_NAME/controller"
