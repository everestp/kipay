...
const (
	SettlementService_VerifyAndSettleTransaction_FullMethodName = "/settlement.SettlementService/VerifyAndSettleTransaction"
)
...
type SettlementServiceClient interface {
	VerifyAndSettleTransaction(ctx context.Context, in *SettlementRequest, opts ...grpc.CallOption) (*SettlementResponse, error)
}
...
func (c *settlementServiceClient) VerifyAndSettleTransaction(ctx context.Context, in *SettlementRequest, opts ...grpc.CallOption) (*SettlementResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SettlementResponse)
	err := c.cc.Invoke(ctx, SettlementService_VerifyAndSettleTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SettlementServiceServer interface {
	VerifyAndSettleTransaction(context.Context, *SettlementRequest) (*SettlementResponse, error)
...
func (UnimplementedSettlementServiceServer) VerifyAndSettleTransaction(context.Context, *SettlementRequest) (*SettlementResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifyAndSettleTransaction not implemented")
}
...
func _SettlementService_VerifyAndSettleTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SettlementRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettlementServiceServer).VerifyAndSettleTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SettlementService_VerifyAndSettleTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettlementServiceServer).VerifyAndSettleTransaction(ctx, req.(*SettlementRequest))
	}
...
var SettlementService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "VerifyAndSettleTransaction",
			Handler:    _SettlementService_VerifyAndSettleTransaction_Handler,
		},
	},
